...
| Luísa Von Zuben Veçoso | 156457 | Mestrado em Ciências Farmacêuticas |
| Rafael Duarte Paes | 224242 | Saúde |

# Descrição Resumida do Projeto
A COVID-19, doença causada pelo vírus SARS-CoV-2, emergiu na China no final de 2019. Com o número crescente de casos avançando globalmente, em março de 2020 a Organização Mundial de Saúde reconheceu a pandemia (WHO 11/03/2020) e instituiu medidas preventivas contra a disseminação, incluindo distanciamento associado à medidas de higiene (WHO 13/03/2020, WHO 16/03/2020) . A doença, transmitida por via respiratória (WIERSINGA et al, 2020),  causou até abril de 2021, mais de 2,9 milhões de óbitos em todo o mundo (https://covid19.who.int/) e mais de 340 mil no Brasil (https://covid.saude.gov.br/). Dentre os diversos impactos da pandemia observados globalmente, o medo da COVID-19 resultou em uma redução na demanda por atendimento médico em situações consideradas não urgentes, incluindo exames diagnósticos de câncer e o próprio tratamento, incluindo quimioterapia, radioterapia ou cirurgia (JINDAL et al, 2020). No Brasil, os diagnósticos de câncer reduziram de 24,3% (região Norte) a 42,7% (região Nordeste), com média de 35,5% no país, correspondentes a 15 mil casos não diagnosticados por mês no período de janeiro a agosto de 2020 (MARQUES et al, 2021)

O tratamento dos pacientes oncológicos também reduziu em alguns países, o que vem sendo uma preocupação desde o início da pandemia (JINDAL et al, 2020; BOUTROS et al, 2021). 
...
Qual o impacto da pandemia de covid-19 nos tratamentos de câncer de mama não metastático em mulheres adultas atendidas no Sistema Único de Saúde (SUS).
...
|COVID-19 | [*CoronavírusBrasil*](https://covid.saude.gov.br/) | Site que fornece os dados do Sistema Único de Saúde - SUS sobre a COVID-19.|
...
Serão incluídos os dados de mulheres com idade ≥ 60 anos, com diagnóstico de câncer de mama, recebendo tratamento não metastático, atendidas no Sistema Único de Saúde (SUS).
...
Este estudo será conduzido com base no modelo de processo *Knowledge Discovery in Databases* (KDD) e suas respectivas etapas descritas por Fayyad e col (1996). Iniciaremos pela seleção das bases de dados que serão utilizadas. Após, as bases de dados serão pré-processadas e tratadas, com o objetivo de entender os dados obtidos, remover dados errados, nulos, irrelevantes ou considerados como outliers. Para a manipulação, cruzamento e análise das bases de dados iremos utilizar a linguagem de programação Python, em alguns momentos será utilizado o programa Jupyter Notebook para auxiliar no desenvolvimento dos códigos que serão criados para o desenvolvimento do projeto. Também será utilizado a ferramenta Orange3 Data Mining e WEKA, que são ferramentas que auxiliam na análise e mineração dos dados.
